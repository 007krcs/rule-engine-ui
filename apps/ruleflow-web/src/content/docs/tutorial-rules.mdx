...
4. **Run + Explain**
   ...
   - Change a bound input value and run **Submit** again to verify rule outcomes change.
...
Date operators are also supported:
- `dateEq`, `dateBefore`, `dateAfter`, `dateBetween`

## Screenshots

![Rules Builder page](/docs/rules-builder.png)

![Trace explain mode](/docs/playground-trace.png)
